      ...
      <div className="row d-flex justify-content-center">
        <div className="col-10 d-flex flex-column justify-content-center my-5">
          <p className="text-justify m-auto">
            ...
            Szervizünkben felkészültek vagyunk a nálunk kapható márkák karbantartására és rendszeres ellenőrzésére. Bízunk benne, hogy megtalálja az Önnek leginkább megfelelő autót, amelynek kiválasztásához minden tőlünk telhető szakmai segítséget megadunk.
          </p>
        </div>
      </div>
    </div>
